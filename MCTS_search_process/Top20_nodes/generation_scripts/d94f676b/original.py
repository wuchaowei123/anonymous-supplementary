#!/usr/bin/env python3
"""
anonymous_institutionAgentMonty - Execution Node: d94f676b
Type: original
Generated: 2026-01-13T12:15:02.738250
Mutation: None
Parent: None
...
1) FIX: LightGBM AWMSE custom objective was defined but NOT USED. Now used via fobj/feval.
...
def train_lgb_aw(X_tr, y_tr, X_va, y_va, seed=42):
    # FIX: use custom objective + custom eval
    params = dict(
    ...
    model = lgb.train(
        ...
        feval=lgb_aw_eval,
        callbacks=[
            lgb.early_stopping(stopping_rounds=300, verbose=False, first_metric_only=True),
...
def main():
    ...
    out_path = "/home/jupyter/anonymous_institutionAgentMonty_1226/tasks/BT_IOS_2503_Pareto/run_deepresearch/improved_lgb_hurdle_results.json"
    try:
