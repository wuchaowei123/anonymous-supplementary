...
Type: fixed
Generated: 2026-01-13T21:08:43.919036
Fix Attempts: 1
...
def main():
    ...
    # === SAVE MODEL ===
    node_dir = "/home/jupyter/AviaAgentMonty_1226/tasks/BT_IOS_2503_Pareto/run_20260112_102800/f3ffe695"
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/f3ffe695")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': 'f3ffe695', 'saved': saved}, f)
...
# ========== CORRECTED SAVING CODE ==========
    ...
    save_dir = Path(f"/home/jupyter/saved_models_final/f3ffe695")
    save_dir.mkdir(parents=True, exist_ok=True)
