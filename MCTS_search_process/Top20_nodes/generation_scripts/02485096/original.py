#!/usr/bin/env python3
"""
anonymous_institutionAgentMonty - Execution Node: 02485096
Type: original
Generated: 2026-01-13T22:52:23.514519
Mutation: None
Parent: None
...
def main():
    ...
    # === SAVE MODEL ===
    node_dir = "/home/jupyter/anonymous_institutionAgentMonty_1226/tasks/BT_IOS_2503_Pareto/run_20260112_102800/02485096"
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/02485096")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': '02485096', 'saved': saved}, f)
...
# ========== CORRECTED SAVING CODE ==========
    ...
    save_dir = Path(f"/home/jupyter/saved_models_final/02485096")
    save_dir.mkdir(parents=True, exist_ok=True)
