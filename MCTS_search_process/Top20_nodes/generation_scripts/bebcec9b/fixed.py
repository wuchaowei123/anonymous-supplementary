#!/usr/bin/env python3
"""
AviaAgentMonty - Execution Node: bebcec9b
Type: fixed
Generated: 2026-01-13T22:42:23.295724
Fix Attempts: 1
...
def main():
    ...
    if clf_zero is not None:
        ...
        te_mask_nneg = np.ones(len(te_users), dtype=bool)
    ...
    # === SAVE MODEL ===
    node_dir = "/home/jupyter/AviaAgentMonty_1226/tasks/BT_IOS_2503_Pareto/run_20260112_102800/bebcec9b"
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/bebcec9b")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': 'bebcec9b', 'saved': saved}, f)
...
# ========== CORRECTED SAVING CODE ==========
    ...
    save_dir = Path(f"/home/jupyter/saved_models_final/bebcec9b")
    save_dir.mkdir(parents=True, exist_ok=True)
