...
def main():
    ...
    # === SAVE MODEL ===
    node_dir = "/home/jupyter/saved_models/9cf73541"
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/9cf73541")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': '9cf73541', 'saved': saved}, f)
...
if __name__ == "__main__":
    y_test_arr, test_predictions, score = main()
