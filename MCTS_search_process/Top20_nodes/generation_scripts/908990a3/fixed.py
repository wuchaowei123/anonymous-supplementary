...
def main():
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/908990a3")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': '908990a3', 'saved': saved}, f)
        print(f"🎉 Saved to {save_dir}")
    except Exception as e:
        print(f"⚠️ Save error: {e}")
    # ========== END SAVING CODE ==========

    return score, final_pred, y_test

if __name__ == "__main__":
    score, test_predictions, y_test_values = main()
...
# ========== CORRECTED SAVING CODE ==========
    ...
    save_dir = Path(f"/home/jupyter/saved_models_final/908990a3")
    save_dir.mkdir(parents=True, exist_ok=True)
