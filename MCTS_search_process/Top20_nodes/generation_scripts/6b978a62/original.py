#!/usr/bin/env python3
"""
AviaAgentMonty - Execution Node: 6b978a62
Type: original
Generated: 2026-01-13T21:18:44.122364
Mutation: None
Parent: None
...
def main():
    ...
    # === SAVE MODEL ===
    node_dir = "/home/jupyter/AviaAgentMonty_1226/tasks/BT_IOS_2503_Pareto/run_20260112_102800/6b978a62"
    ...
    try:
        ...
        save_dir = Path("/home/jupyter/saved_models/6b978a62")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': '6b978a62', 'saved': saved}, f)
...
# ========== CORRECTED SAVING CODE ==========
    ...
    save_dir = Path(f"/home/jupyter/saved_models_final/6b978a62")
    save_dir.mkdir(parents=True, exist_ok=True)
