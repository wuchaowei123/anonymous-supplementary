...
def main():
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/433ffc18")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': '433ffc18', 'saved': saved}, f)
...
# ========== CORRECTED SAVING CODE ==========
    ...
    save_dir = Path(f"/home/jupyter/saved_models_final/433ffc18")
    save_dir.mkdir(parents=True, exist_ok=True)
