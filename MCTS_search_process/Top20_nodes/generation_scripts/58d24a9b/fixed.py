#!/usr/bin/env python3
"""
anonymous_institutionAgentMonty - Execution Node: 58d24a9b
Type: fixed
Generated: 2026-01-13T01:13:31.969243
Fix Attempts: 1
...
def main():
    ...
    print(f"score = {score}")
    # === SAVE MODEL ===
    node_dir = "/home/jupyter/anonymous_institutionAgentMonty_1226/tasks/BT_IOS_2503_Pareto/run_20260112_102800/58d24a9b"
    ...
    try:
        ...
        import joblib
        save_dir = Path("/home/jupyter/saved_models/58d24a9b")
        ...
        with open(save_dir / "metadata.json", 'w') as f:
            json.dump({'node_id': '58d24a9b', 'saved': saved}, f)
...
if __name__ == "__main__":
    ...
    print(f"Saved predictions to {save_dir}/predictions.csv ({len(pred_df)} rows)")
